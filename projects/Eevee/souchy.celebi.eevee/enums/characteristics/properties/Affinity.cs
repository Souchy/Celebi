...
namespace souchy.celebi.eevee.enums.characteristics.creature
{
    public sealed record Affinity : CharacteristicType
    {
        ...
        public Affinity(int localId, string name, ElementType ele = ElementType.None) : base(CharacteristicCategory.Affinity, localId, name, SimpleFactory)
        {
            this.Element = ele;
        ...
        public static readonly Affinity Melee       = new(8,  nameof(Melee));
