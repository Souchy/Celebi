import { Affinity, AffinityTypes, Contextual, ContextualTypes, OtherProperty, OtherPropertyTypes, Resistance, ResistanceTypes, Resource, ResourceTypes, SpellModelProperty, SpellModelPropertyTypes, SpellProperty, SpellPropertyTypes, State, StateTypes, StatusModelProperty, StatusModelPropertyTypes } from "./services/api/data-contracts";
